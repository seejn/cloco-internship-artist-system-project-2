    ...
    export default {
        ...
        methods: {
            ...
            async signIn() {
                ...
                .then((response) => {
                    console.log("after signing in", response.data)
                    ...
                    else if(response.data.data.is_artist){
                    ...
                    if(response.data.data.is_admin) this.$router.push("/admin/dashboard")
                    else if(response.data.data.is_artist) this.$router.push("/artist/home")
